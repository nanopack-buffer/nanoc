...
std::unique_ptr<{{if .Namespace}}{{.Namespace}}::{{end}}{{.Schema.Name}}> {{if .Namespace}}{{.Namespace}}::{{end}}{{.FactoryFunctionName}}(std::vector<uint8_t>::const_iterator begin, int &bytes_read) {
